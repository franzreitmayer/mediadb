sap.ui.require([
  ...
  var sViewName = "eu.reitmayer.ui5.mediadb.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "eu.reitmayer.ui5.mediadb"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title eu.reitmayer.ui5.mediadb"
            });
        }
      }
